...
GEC、GEP、GTransporter、そして今回のGETLは個人ベースの映像制作環境(VP)を実現することを目標に制作されています、その他の用途でご使用される場合は
意図する動作をしてくれないケースもあるかと思います、その際は運用方法やコードのカスタマイズなどで、ご自分が使い易くできるようにOSS公開としました。
当ツール群が開発元のライセンスを毀損しないものについては、今後順次OSS公開していきますので、是非ともご活用してください。
